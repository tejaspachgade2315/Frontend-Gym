...
export default function LeadsTable({ searchQuery }) {
  ...
  const fetchLeads = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.get<{ leads: Lead[] }>(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/lead/loss`, {
  ...
  const handleExportToExcel = async () => {
    ...
    XLSX.writeFile(workbook, "loss_leads.xlsx");
  };
  ...
  return (
    <div>
      ...
      <Table className="hidden md:table">
        <TableCaption>List of Lost Leads</TableCaption>
        <TableHeader>
          <TableRow>
