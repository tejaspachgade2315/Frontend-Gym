...
import AddEquipmentModal from "./addequiment";
...
export default function InventoryHeader({ searchQuery, setSearchQuery }: InventoryHeaderProps) {
  ...
  return (
    <div className="sticky top-16 z-10 bg-background">
      <div className="flex-col items-center justify-between space-y-2 md:flex md:flex-row">
        <h2 className="text-3xl font-bold tracking-tight">Equiment</h2>
